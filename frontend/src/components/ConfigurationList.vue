  ...
  <div class="mt-12 pt-8 border-t border-gray-200">
    <div class="space-y-3">
      <div
        ...
        :key="config.id"
        class="flex items-center justify-between p-4 bg-white border border-zenrows-card-border rounded-xl hover:shadow-card transition-shadow"
      >
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-zenrows-text-secondary">
              {{ config.origin.description.substring(0, 60) }}...
            </p>
          </div>
        </div>
